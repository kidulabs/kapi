...
async fn main() {
    ...
    for store in &stores {
        ...
        run_test!("create_non_object_spec", object_crud::test_create_non_object_spec);
        run_test!(
        ...
        println!();
        run_test!("create_object_with_labels", object_labels::test_create_object_with_labels);
        run_test!("create_object_without_labels", object_labels::test_create_object_without_labels);
        run_test!("update_object_labels", object_labels::test_update_object_labels);
        run_test!("create_schema_with_labels", object_labels::test_create_schema_with_labels);
        run_test!("invalid_label_key_400", object_labels::test_invalid_label_key_format);
        run_test!("invalid_label_value_400", object_labels::test_invalid_label_value_format);
        run_test!("label_key_too_long_400", object_labels::test_label_key_exceeds_length);
        run_test!("label_value_too_long_400", object_labels::test_label_value_exceeds_length);
        ...
        run_test!("update_object_annotations", object_annotations::test_update_object_annotations);
        run_test!(
        ...
        run_test!("annotation_size_limit", object_annotations::test_annotation_size_limit);
        run_test!(
        ...
        println!();
        run_test!("list_with_field_selector", list_filtering::test_list_with_field_selector);
        run_test!("list_with_label_selector", list_filtering::test_list_with_label_selector);
        run_test!("list_with_both_selectors", list_filtering::test_list_with_both_selectors);
        run_test!("list_filter_with_pagination", list_filtering::test_list_filter_with_pagination);
        run_test!("list_filter_no_matches", list_filtering::test_list_filter_no_matches);
        run_test!(
        ...
        run_test!("list_invalid_field_selector", list_filtering::test_list_invalid_field_selector);
        run_test!("list_invalid_label_selector", list_filtering::test_list_invalid_label_selector);
        ...
        println!();
        run_test!("status_update_with_schema", status_subresource::test_status_subresource_update);
        run_test!("status_not_enabled", status_subresource::test_status_subresource_not_enabled);
        run_test!("status_invalid_data", status_subresource::test_status_subresource_invalid_data);
        run_test!(
        ...
        run_test!("status_preserves_spec", status_subresource::test_status_update_preserves_spec);
        run_test!("status_bumps_rv", status_subresource::test_status_update_bumps_resource_version);
        run_test!(
