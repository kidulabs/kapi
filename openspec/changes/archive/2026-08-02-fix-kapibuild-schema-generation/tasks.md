...
- [x] **Task 1: Update `write_helper_cargo_toml()`**
...
- [x] **Task 2: Update `generate_wrapper_code()`**
...
- [x] **Task 3: Update `write_helper_main_rs()`**
...
- [x] **Task 6: Update `cmd_api_generate()`**
...
- [x] **Task 8: Manual test with local build**
...
- [x] **Task 9: Manual test with crates.io-style install**
