...
- `Cargo.toml` with dependencies on kapi-core, kapi-client, kapi-controller, serde, tokio, tracing, async-trait, schemars
...
- **THEN** system returns an error indicating the directory already exists
