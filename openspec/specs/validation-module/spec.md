...
Define the stateless format validation module for labels and annotations. This module provides pure functions callable from any layer (handler, service, tests) without dependencies on the store, event bus, schema registry, or any I/O.
