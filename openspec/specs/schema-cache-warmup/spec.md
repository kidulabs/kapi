...
Define the schema cache warmup behavior that ensures compiled user schemas survive server restarts through eager loading at startup and lazy compilation fallback at runtime.
