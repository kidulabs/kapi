...
Define the unit test requirements for the `ObjectStore` trait's `InMemoryStore` implementation, covering CRUD operations, pagination, and optimistic concurrency.
