...
- [ ] **Extract SchemaRegistry** — Extract schema compilation, caching, and lookup from `ObjectService` into a `SchemaRegistry` collaborator (`openspec/changes/extract-schema-registry`)
